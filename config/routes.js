...
module.exports.routes = {
  ...
  '/home' : 'MemberController',

  '/welcome': 'MemberController.welcome',

  '/profile': 'MemberController.profile',

  '/logout': 'MemberController.logout',

  /***** PUBLISHER CONTROLLER *****/

  '/publish' : 'PublisherController.index',

  '/publisher/add' : 'PublisherController.add',
  ...
  '/story/add' : 'StoryController.add',

  '/story/edit' : 'StoryController.edit',

  '/story/read' : 'StoryController.read',
